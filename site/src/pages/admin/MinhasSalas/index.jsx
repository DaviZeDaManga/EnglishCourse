...
export default function MinhasSalas() {
    ...
    async function minhasSalas() {
        ...
        try {
            ...
            setSalas("Você não tem nenhuma sala.")
        }
    }
        ...
        <section className='MinhasSalas'>
            ...
            <section className='SectionCards'>
                <section onClick={() => setCardadd(true)} className='AddButton cor1 border'>
                    <section className={`DescCard border cor2 `}>
                        <div className='linha'></div>
                        <img className='meio fourty' src='/assets/images/icones/mais.png' alt="Adicionar nova sala" />
                    </section>
                </section>

                {(salas == "Loading" || salas == "Você não tem nenhuma sala.") 
